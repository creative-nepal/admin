...
name: i18n-strings
description: >
  Render user-visible text in creative-nepal-admin through the i18n catalogue instead of
...
`GET /api/v1/i18n/:lang`. Keys for the dashboard live under `ui.admin.*`. Adding a key means editing
...
t("ui.admin.plans.title");
t("ui.admin.content.deleted", { slug });   // {slug} interpolates
```
